...
class LSeg(BaseModel):
    ...
    def forward(self, x, labelset=''):
        ...
        # print(self.logit_scale)  # tensor(14.2857, grad_fn=<ExpBackward>)
        ...
        image_features_to_dump = image_features / image_features.norm(dim=1, keepdim=True)
        torch.save(image_features_to_dump, 'image_feat.pt')
        ...
        # print("image_features.shape: ", image_features.shape)
        # image_features_to_dump = image_features.view(imshape[0], imshape[2], imshape[3], -1).permute(0,3,1,2)
        # print("image_features_to_dump.shape: ", image_features_to_dump.shape)
        # torch.save(image_features_to_dump, 'image_feat.pt')
