...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Process only semantic data",
    )
    parser.add_argument(
        "--process_keys",
        nargs="+",
    ...
    if args.dataset == "waymo":
        ...
        dataset_processor = WaymoProcessor(
            ...
            only_process_semantic=args.only_process_semantic,
        )
    elif args.dataset == "argoverse":
        from preproc.argoverse.argoverse_preprocess import ArgoVerseProcessor
        dataset_processor = ArgoVerseProcessor(
            load_dir=args.data_root,
            save_dir=args.target_dir,
            process_keys=args.process_keys,
            process_id_list=scene_lists,
