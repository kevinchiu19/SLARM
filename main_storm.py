...
from engine_tools import evaluate, evaluate_flow, visualize
...
from src.dataset.datasets import PerceptualModelDataset, PerceptualModelDatasetEval
...
def get_args_parser():
    ...
    parser.add_argument("--camera_loss_coeff", type=float, default=0.1)
...
def main(args):
    ...
    dataset_train = PerceptualModelDataset(
    ...
    if val_annotation is not None:
        dataset_val = PerceptualModelDataset(
            data_root=args.data_root,
        ...
        dataset_eval = PerceptualModelDatasetEval(
            data_root=args.data_root,
            annotation_txt_file_list=val_annotation,
            target_size=args.input_size,
            num_context_timesteps=args.num_context_timesteps,
        ...
        dataset_eval_flow = PerceptualModelDatasetEval(
            data_root=args.data_root,
            annotation_txt_file_list=val_annotation,
            target_size=args.input_size,
            num_context_timesteps=args.num_context_timesteps,
    ...
    for data_dict in metric_logger.log_every(
        ...
        with torch.autocast("cuda", dtype=dtype):
            ...
            loss_dict = compute_loss(pred_dict, input_dict, target_dict, args, rgb_and_lpips_loss)
